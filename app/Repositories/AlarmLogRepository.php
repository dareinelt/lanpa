...
{
    private const COLUMNS = 'id, navigation_id, title, alarm_text, group_number, group_description, status, message, triggered_at';
    ...
    {
        $statement = $this->pdo->prepare(
            'INSERT INTO alarm_log (navigation_id, title, alarm_text, group_number, group_description, status, message, triggered_at)
             VALUES (:navigation_id, :title, :alarm_text, :group_number, :group_description, :status, :message, :triggered_at)'
        );
        $statement->execute([
